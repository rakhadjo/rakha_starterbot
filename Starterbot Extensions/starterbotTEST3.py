...
def handle_command(command, channel):
	...
	elif command.startswith(hi) or command.startswith(hey) or command.startswith(hello) or command.startswith(greetings) or command.startswith(salutations) or command.startswith(whatsup)
